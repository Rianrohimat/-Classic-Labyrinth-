...
public class CameraController : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        var frustumHeight = 2 * camDistance * Mathf.Tan(cam.fieldOfView * 0.5f);
    ...
    private void Drag(Touch[] touches)
    {
        ...
        cam.transform.position -= new Vector3(touch.deltaPosition.x, 0, touch.deltaPosition.y * Mathf.Deg2Rad) * 0.001f;
    }
